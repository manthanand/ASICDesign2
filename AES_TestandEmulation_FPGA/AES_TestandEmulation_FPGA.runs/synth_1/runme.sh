...
HD_PWD='C:/Users/manth/Github/ASICDesign2/AES_TestandEmulation_FPGA/AES_TestandEmulation_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_Testbenchsp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES_Testbenchsp.tcl
