...
HD_PWD='C:/Users/manth/Github/ASICDesign2/AES_Emulation_FPGA/AES_Emulation_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_Core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES_Core.tcl
