...
HD_PWD='C:/Users/manth/Github/ASICDesign2/AES_TestandEmulation_FPGA/AES_TestandEmulation_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_Testbenchsp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AES_Testbenchsp.tcl -notrace
